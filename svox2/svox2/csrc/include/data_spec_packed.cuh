...
struct PackedGridOutputGrads {
    PackedGridOutputGrads(GridOutputGrads& grads) :
        ...
        grad_rays_o_out(grads.grad_rays_o_out.defined() ? grads.grad_rays_o_out.data_ptr<float>() : nullptr),
        grad_rays_d_out(grads.grad_rays_d_out.defined() ? grads.grad_rays_d_out.data_ptr<float>() : nullptr),
    ...
    // Taekkii added: grad for rays
    float* __restrict__ grad_rays_o_out;
    float* __restrict__ grad_rays_d_out;
