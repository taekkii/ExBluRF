...
void volume_render_cuvol_fused_backward(SparseGridSpec &, RaysSpec &, RenderOptions &,
                                        Tensor, float, float, Tensor, GridOutputGrads &);
...
#define _REG_FUNC(funname) m.def(#funname, &funname)
  ...
  _REG_FUNC(volume_render_cuvol_fused_backward);
...
#undef _REG_FUNC
  ...
  py::class_<RenderOptions>(m, "RenderOptions")
      ...
      .def_readwrite("background_r", &RenderOptions::background_r)
      .def_readwrite("background_g", &RenderOptions::background_g)
      .def_readwrite("background_b", &RenderOptions::background_b);
  ...
  py::class_<GridOutputGrads>(m, "GridOutputGrads")
      ...
      .def_readwrite("grad_rays_o_out", &GridOutputGrads::grad_rays_o_out)
      .def_readwrite("grad_rays_d_out", &GridOutputGrads::grad_rays_d_out)
